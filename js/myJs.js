const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn TAnh năm mới tốt đẹp gặp nhiều may mắn ko bị xì chét :)) 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/TAnh.jpg",    //ảnh pop up đầu
      imageWidth: 370,
      imageHeight: 250,
